...
doc.list([
    ...
    "構内では下記ルールを守って頂くようお願いいたします"], 70, 350,
    {listType: "numbered", indent: 0, bulletIndent:0, textIndent:20, paragraphGap: 1, align: "left", width: 400});
doc.list([
    "歩行者の歩行を妨げない", 
    "歩道などで一時停止と安全確認", 
    "場内追い越し禁止", 
    "場内の運転は時速10km以下"], 90, 470,
    {listType: "bullet", indent: 0, bulletIndent:0, textIndent:20, paragraphGap: 1, align: "left", width: 400});
doc.moveDown();
doc.font("./fonts/BoschSansJapanese-Bold-v2_301.ttf");
...
doc.list([
    ...
    "We kindly request your cooperation in observing the following rules while in the parking lot:"], 70, 550,
    {listType: "numbered", indent: 0, bulletIndent: 0, textIndent: 20, paragraphGap: 1, align: "left", width: 400});
doc.list([
    ...
    "Please drive within the parking lot at a speed of 10km/h or below"], 90, 730,
    {listType: "bullet", indent: 0, bulletIndent: 0, textIndent: 20, paragraphGap: 1, align: "left", width: 400});
